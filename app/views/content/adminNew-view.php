        ...
        <div class="content-wrapper" style="min-height: 227px;">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Nuevo Administrativo</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                                <li class="breadcrumb-item active">Nuevo Administrativo</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-12 col-6">
                            <div class="card card-lightblue">
                                <div class="card-header">
                                    <h3 class="card-title">Agregar nuevo administrativo</h3>
                                </div>
                                <form action="<?php echo APP_URL; ?>app/ajax/adminAjax.php" method="post" autocomplete="off" class="FormularioAjax"
                                enctype="multipart/form-data">
                                <input type="hidden" name="modulo_administrativo" value="registrar">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <label for="nombre">Nombre</label>
                                                    ...
                                                    pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,40}" name="administrativoNombre" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-border border-width-2"
                                                    pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,40}" name="administrativoApellido" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control form-control-border border-width-2" name="administrativoDocumentacionNumero">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="row">
                                                    <div class="form-group mr-2">
                                                        <label>CUIL</label>
                                                        <input type="text" class="form-control form-control-border border-width-2"
                                                        pattern="[0-9]{11,20}" name="administrativoCuil" required>
                                                    </div>
                                                    <div class="form-group ml-2">
                                                        <label>Número Seguro Social</label>
                                                        <input type="text" class="form-control form-control-border border-width-2"
                                                        pattern="[0-9]{7,100}" name="administrativoNumeroSegSocial">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <label for="cuil">Nombre de Usuario</label>
                                                    <input type="text" class="form-control form-control-border border-width-2"
                                                    pattern="[a-zA-Z0-9]{4,20}" name="administrativoUsuario">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <label for="cuil">Correo</label>
                                                    <input type="text" class="form-control form-control-border border-width-2" name="administrativoCorreo">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                <label for="cuil">Telefono (Ej: 3704123456)</label>
                                                    <input type="text" class="form-control form-control-border border-width-2"
                                                    pattern="[0-9]{10,10}" name="administrativoTelefono">
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <label for="cuil">Calle</label>
                                                    <input type="text" class="form-control form-control-border border-width-2"
                                                    pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ0-9 ]{7,100}" name="administrativoCalle">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="row">
                                                    <div class="form-group mr-2">
                                                        ...
                                                        <input type="text" class="form-control form-control-border border-width-2"
                                                        pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ0-9 ]{7,100}" name="administrativoBarrio">
                                                    </div>
                                                    <div class="form-group ml-2">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-border border-width-2"
                                                    pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{4,40}" name="administrativoSector" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
