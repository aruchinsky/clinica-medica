...
<div class="content-wrapper" style="min-height: 227px;">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Informe de Medicos por Especialidad</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                        <li class="breadcrumb-item active">Informe de Medicos por Especialidad</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-10 offset-md-1">
                                                <div class="row">
                                                    <!-- Especialidad -->
                                                    <div class="col-4">
                                                            <select class="btn bg-lightblue dropdown-toggle" style="width: 100%; height: 75%;"  id="category" name="medicoEspecialidadFil">
                            ...
                            <?php } else { ?>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <?php
                                            echo $insMedico->listarMedicoAvanzadoEspecialidad($url[1], 10, $url[0], $_SESSION['busquedaAvanzadaMedico']);
                                        }
                                        ?>
