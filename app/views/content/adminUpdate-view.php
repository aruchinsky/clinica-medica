...
<div class="content-wrapper" style="min-height: 227px;">
	<?php 
		...
		$idUsuario=$insLogin->limpiarCadena($url[1]);
            ...
            $datos=$insLogin->ejecutarConsultaLibre("SELECT a.id idAdministrativos, p.id idPersonas, u.id idUsuarios, c.id idContactos, te.descripcion TipoEmpleado, td.id idTipoDocumentacion,
                                                            dir.id idDirecciones, d.id idDocumentaciones, pro.id idProvincia, a.sector Sector,
                                                            ...
                                                            a.fecha_creacion FechaCreacion, a.ultima_modificacion UltimaModificacion
    ...
    ?>
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0">Actualizar Administrativo</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                                    <li class="breadcrumb-item active">Actualizar Administrativo</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-12 col-6">
                                <div class="card card-lightblue">
                                    <div class="card-header">
                                        <h3 class="card-title"><?php echo $datos['Nombre']." ".$datos['Apellido']." ( ".$datos['Sector']." )"; ?></h3>
                                    </div>
                                    ...
                                    <form action="<?php echo APP_URL; ?>app/ajax/adminAjax.php" method="post" autocomplete="off" class="FormularioAjax">
                                        <input type="hidden" name="modulo_administrativo" value="actualizar">
                                        <input type="hidden" name="administrativo_id" value="<?php echo $datos['idAdministrativos']; ?>">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                    <label>Nombre</label>
                                                        <input type="text" class="form-control form-control-border border-width-2" name="adminNombre"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-border border-width-2" name="adminApellido"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <select class="btn btn-info dropdown-toggle" id="category" name="adminDocumentacionTipo" required="">
                                                            ...
                                                            <input type="text" class="form-control form-control-border border-width-2" name="adminDocumentacionNumero"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="row">
                                                        <div class="form-group mr-2">
                                                            ...
                                                            pattern="[0-9]{11,20}" name="adminCuil" value="<?php echo $datos['Cuil']; ?>" required>
                                                        </div>
                                                        <div class="form-group ml-2">
                                                            <label>Número Seguro Social</label>
                                                            <input type="text" class="form-control form-control-border border-width-2"
                                                            pattern="[0-9]{7,100}" name="adminNumeroSegSocial" value="<?php echo $datos['numSegSocial']; ?>" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <label>Nombre de Usuario</label>
                                                        <input type="text" class="form-control form-control-border border-width-2" name="adminUsuario"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="row">
                                                        <div class="form-group mr-2">
                                                            ...
                                                            <input type="text" class="form-control form-control-border border-width-2"
                                                            pattern="[a-zA-Z0-9$@.-]{4,100}"  name="adminClave1">
                                                        </div>
                                                        <div class="form-group ml-2">
                                                            <label for="cuil">Confirmar Clave</label>
                                                            <input type="text" class="form-control form-control-border border-width-2"
                                                            pattern="[a-zA-Z0-9$@.-]{4,100}" name="adminClave2">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                    <label>Correo</label>
                                                        <input type="text" class="form-control form-control-border border-width-2" name="adminCorreo"
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <label>Telefono</label>
                                                        <input type="text" class="form-control form-control-border border-width-2" name="adminTelefono"
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                    <label>Calle</label>
                                                        <input type="text" class="form-control form-control-border border-width-2" name="adminCalle"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="row">
                                                        <div class="form-group mr-2">
                                                            ...
                                                            <input type="text" class="form-control form-control-border border-width-2"
                                                            pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ0-9 ]{1,100}" value="<?php echo $datos['Barrio']; ?>" name="adminBarrio">
                                                        </div>
                                                        <div class="form-group ml-2">
                                                            <label for="provincia">Provincias</label>
                                                            <select class="form-control btn-info dropdown-toggle" id="category" name="adminProvincia" required="">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                    <label>Sector</label>
                                                        <input type="text" class="form-control form-control-border border-width-2" name="adminSector"
                                                        pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{4,20}" value="<?php echo $datos['Sector']; ?>" required>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
