...
<div class="content-wrapper" style="min-height: 227px;">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Búsqueda de Técnico de Salud</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                        <li class="breadcrumb-item active">Búsqueda de Técnico de Salud</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card card-lightblue">
                        <div class="card-body">
                            ...
                            <div class="columns">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <form class="FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/buscadorAjax.php" method="POST" autocomplete="off" >
                                        ...
                                        <input type="hidden" name="modulo_entidad" value="tecnico">
                                        ...
                                        <div class="row">
                                            <div class="col-md-10 offset-md-1">
                                                <div class="row">
                                                    ...
                                                    <!-- Provincia -->
                                                    <div class="col-4">
                                                            <select class="btn bg-lightblue dropdown-toggle" style="width: 100%; height: 75%;" id="category" name="tecnicoProvinciaFil">
                                                    ...
                                                    <!-- Ordenar por -->
                                                    <div class="col-3">
                                                            <select class="btn bg-lightblue dropdown-toggle" style="width: 100%; height: 75%;" id="category" name="tecnicoOrdenarPorFil">
                            ...
                            <?php } else { ?>
                                                    ...
                                                    <div class="col-4">
                                                        <select class="btn bg-lightblue dropdown-toggle" style="width: 100%; height: 75%;" id="category" name="tecnicoProvinciaFil">
                                                            ...
                                                            <?php
                                                                foreach($consultaProvincias as $dato){
                                                            ?>
                                                            <option value="<?php echo $dato->id ?>" <?php echo ($_SESSION['AvanzadaTecnico'][1] == $dato->id) ? 'selected' : ''; ?> class="form-control"><?php echo $dato->nombre ?></option>
                                ...
                                <div class="card-body">
                                        <?php
                                            echo $insTecnic->listarTecnicoAvanzadoControlador($url[1], 10, $url[0], $_SESSION['AvanzadaTecnico']);
                                        }
                                        ?>
                                    ...
                                    <div class="card-footer">
                                        <div class="float-right">
                                            <div class="btn-group btn-group-lg">
                                                <a href="<?php echo APP_URL; ?>app/views/fpdf/reporte_tecnico.php" target="_blank" class="btn bg-navy">
                                                    <i class="fa-regular fa-file-pdf"></i>
                                                </a>
                                                <a href="<?php echo APP_URL; ?>app/views/excel/excel_tecnico.php" target="_blank" class="btn bg-navy">
