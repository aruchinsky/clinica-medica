                        ...
                        <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-10 offset-md-1">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <!-- Ordenar por -->
                                                    <div class="col-3">
                                                            <select class="btn bg-lightblue dropdown-toggle" style="width: 100%; height: 75%;" id="category" name="medicoOrdenarPorFil">
                                                                ...
                                                                <option value="4" class="form-control">Situacion de Revista</option>
                                                                <option value="5" class="form-control">Especialidades</option>
                                                                <option value="6" class="form-control">Provincias</option>
                                                            </select>
                                                    </div>
                                    </form>
                                                    <!-- Limpiar Busqueda -->
                            ...
                            <?php } else { ?>
                                                            ...
                                                            <label>Provincia</label>
                                                                <select class="btn bg-lightblue dropdown-toggle" style="width: 100%;" id="category" name="medicoProvinciaFil">
                                                                    ...
                                                                    <?php
                                                                            foreach($consultaProvincias as $dato){
                                                                        ?>
                                                                        <option value="<?php echo $dato->id ?>" <?php echo ($_SESSION['busquedaAvanzadaMedico'][1] == $dato->id) ? 'selected' : ''; ?> class="form-control"><?php echo $dato->nombre ?></option>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="btn bg-lightblue dropdown-toggle" style="width: 100%;" id="category" name="medicoEspecialidadFil">
                                                                    ...
                                                                    <?php
                                                                        foreach($consultaEspecialidades as $dato){
                                                                    ?>
                                                                            <option value="<?php echo $dato->id ?>" <?php echo ($_SESSION['busquedaAvanzadaMedico'][2] == $dato->id) ? 'selected' : ''; ?> class="form-control"><?php echo $dato->descripcion ?></option>
                                                                    <?php
                                                                        } 
                                                                    ?>
                                                            </select>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="btn bg-lightblue dropdown-toggle" style="width: 100%;" id="category" name="medicoSituacionRevistaFil">
                                                                    ...
                                                                    <?php
                                                                        foreach($consultaSituacionRevista as $dato){
                                                                    ?>
                                                                        <option value="<?php echo $dato->id ?>" <?php echo ($_SESSION['busquedaAvanzadaMedico'][3] == $dato->id) ? 'selected' : ''; ?> class="form-control"><?php echo $dato->descripcion ?></option>
                                                                    <?php
                                                                        } 
                                                                    ?>
                                                            </select>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <?php
                                            echo $insMedico->listarMedicoAvanzadoControlador($url[1], 10, $url[0], $_SESSION['busquedaAvanzadaMedico']);
                                        }
                                        ?>
                                    ...
                                    <div class="card-footer">
                                        <div class="float-right">
                                            <div class="btn-group btn-group-lg">
                                                <a href="<?php echo APP_URL; ?>app/views/fpdf/reporte_medicos.php" target="_blank" class="btn bg-navy">
                                                    <i class="fa-regular fa-file-pdf"></i>
                                                </a>
                                                <a href="<?php echo APP_URL; ?>app/views/excel/excel_v2.php" target="_blank" class="btn bg-navy">
