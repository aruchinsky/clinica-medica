...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(50, 10, utf8_decode('Provincia'), 1, 0, 'C', 1);
      $this->Cell(40, 10, utf8_decode('Fecha de Alta'), 1, 0, 'C', 1);
      $this->Cell(50, 10, utf8_decode('Cuil'), 1, 1, 'C', 1);
   }
...
foreach($consulta_reporte as $dato){
      ...
      $pdf->Cell(40, 10, utf8_decode($dato['tipoEmpleado']), 1, 0, 'C', 0);
      $pdf->Cell(50, 10, utf8_decode($dato['provincia']), 1, 0, 'C', 0);
      $pdf->Cell(40, 10, utf8_decode($dato['fechaAlta']), 1, 0, 'C', 0);
      $pdf->Cell(50, 10, utf8_decode($dato['Cuil']), 1, 1, 'C', 0);
      $i = $i + 1;
}
